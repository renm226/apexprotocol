export const mobileData = {
  ...
  area: "mobile",
  eyebrow: "iOS Â· Android Â· React Native Â· Flutter Â· App Architecture Â· App Store",
  sub: "Build production-grade mobile applications trusted by millions of users. This roadmap covers native iOS development in Swift, native Android in Kotlin, cross-platform approaches with React Native and Flutter, and the full deployment lifecycle â€” from App Store submission to crash monitoring and analytics. Everything you need to ship and maintain real apps.",
  phases: [
    {
      ...
      topics: [
        ...
        },
        {
          ...
          tag: "core",
          desc: "MVC (Model-View-Controller) â€” issues (massive view controller). MVVM (Model-View-ViewModel) with data binding. VIPER (View-Interactor-Presenter-Entity-Router) for clean separation. Redux/Flux pattern (single source of truth). MVI (Model-View-Intent) for reactive architectures. Choosing the right pattern for scale.",
          master: [
      ...
      topics: [
        {
          ...
          res: [
            "Swift Programming Language (Apple Books â€” free)",
